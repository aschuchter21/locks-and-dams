...
public final class CustomChecks {
    ...
    @SubscribeEvent public static void start(ServerStartedEvent e) {
        if(!Boolean.getBoolean("locksanddams.customChecks")||Boolean.getBoolean("locksanddams.controllerRecovery")||Boolean.getBoolean("locksanddams.controllerRelocation"))return;server=e.getServer();level=server.overworld();
        try {
