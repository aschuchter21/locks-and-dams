...
public final class RecessChecks {
    ...
    static void finish(Throwable error){done=true;try{Files.writeString(Path.of("recess-checks-result.txt"),error==null?"PASS: recessed widths 4, 7, 10, 16; four orientations; saved geometry; full lower gate opening and closing with signed rotation; open gates parallel to walls.\n":"FAIL: "+error+"\n");}catch(Exception ignored){}if(error!=null)error.printStackTrace();server.halt(false);}
